  ...
  return (
    ...
    <div className="w-full flex justify-between items-center font-semibold">
      ...
      <div className="flex items-center gap-4">
        <p className="px-4 py-1.5 cursor-pointer bg-white text-black text-[15px] rounded-full hidden md:block">Explore Premium</p>
        <p className="px-4 py-1.5 cursor-pointer bg-white text-black text-[15px] rounded-full hidden md:block">Install App</p>
        {
          isAuth?(
            <p onClick={logoutUserHandler} className="px-4 py-1.5 cursor-pointer bg-white text-black text-[15px] rounded-full">Logout</p>
          ):(
            <p onClick={()=>navigate("/login")}  className="px-4 py-1.5 cursor-pointer bg-white text-black text-[15px] rounded-full">Login</p>
          )
        }
      </div>
    </div>

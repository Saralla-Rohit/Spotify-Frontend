    ...
    <div>
      {
        song && <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
          <div className="lg:flex items-center gap-4">
            <img src={song.thumbnail ? song.thumbnail : "/music.icon.jpg"} className="w-12" alt="" />
          ...
          <div className="flex flex-col items-center gap-1 m-auto">
            {song.audio && (<audio ref={audioRef} src={song.audio} autoPlay={isPlaying}></audio>
            )}
            <div className="width-full items-center flex font-thin text-green-400">
